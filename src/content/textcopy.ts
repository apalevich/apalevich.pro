        ...
        services: [
            {
                ...
                description: "Seamless website support that keeps your core IT team focused on product development. We handle all technical updates, ensuring your online presence remains smooth and efficient."
            },
            {
                icon: "📩",
                title: "Email Marketing",
                description: "Comprehensive email marketing solutions backed by expert strategic insights. We design, implement, and optimize campaigns that drive engagement and conversion."
            },
            {
                icon: "👩🏻‍🔬",
                title: "Hypothesis Validation",
                description: "Rapid MVP development to test and validate your business ideas quickly. We back up you by setting up robust analytics systems to gather reliable, actionable data that guide your strategic decisions."
            },
        ],
    },
    staff: {
